...
#' where \mjseqn{W(\textbf{x},\boldsymbol\omega)} is said to be a non degenerate kernel function. Set \mjseqn{W(\textbf{x},\boldsymbol\omega)=\exp(i\boldsymbol\omega^T\textbf{x})} for 
