...
#' Then, for a random finite sequence of \mjseqn{\boldsymbol{\omega}_j \in {R}^p}, \mjseqn{j=1,\cdots,t} compute \mjseqn{\widehat{\boldsymbol{\psi}}(\boldsymbol{\omega}_j)} as follows. For more details see Weng and Yin (2018).  
